        ...
        child: newsapi.apidataAll?.status == FutureStatus.pending
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    padding:
                        EdgeInsets.only(top: 8, right: 0, bottom: 16, left: 20),
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => NewsPage(
                                data: newsapi.apidataAll?.value?.data?[index]),
                          ),
                        );
                      },
                      child: FittedBox(
                        ...
                        child: Material(
                          ...
                          child: AnimatedContainer(
                            ...
                            child: newsapi.apidataAll?.status ==
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                                "${newsapi.apidataAll?.value?.category}"),
                                            Text(
